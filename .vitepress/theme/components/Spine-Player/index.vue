...
const spineAssets = {
  arona: {
    skelUrl: "/bluearchive/spine_assets/arona/arona_spr.skel",
    atlasUrl: "/bluearchive/spine_assets/arona/arona_spr.atlas",
  ...
  plana: {
    skelUrl: "/bluearchive/spine_assets/plana/plana_spr.skel",
    atlasUrl: "/bluearchive/spine_assets/plana/plana_spr.atlas",
    idleAnimationName: "Idle_01",
    eyeCloseAnimationName: "Eye_Close_01",
    rightEyeBone: "R_Eye_01",
    leftEyeBone: "L_Eye_01",
